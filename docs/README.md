...
| [roles.md](roles.md) | 主干与旁路角色矩阵、写入范围、业务知识钩子、协作协议与交接格式 |
...
| [agent-spec-and-workflow-review-2026-09-18.md](../draft/agent-spec-and-workflow-review-2026-09-18.md) | Agent 职责、流程规范与工作流约束全仓审计报告（2026-09-18）：实现冲突、自我冲突与冗余简化分析                                            |
